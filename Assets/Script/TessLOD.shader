Shader "Examples/TessLOD"
{
    Properties
    {
        ...
        // Intégration des Propriétés de Tessellation pour le Niveau de Détail dans le Shader
	...
	SubShader
    {
        ...
        Pass
        {
            ...
            // Ajout des propriétés de Tessellation LOD (Projet URP)
			sampler2D _BaseTex;
			...
			tessFactors patchConstantFunc(InputPatch<tessControlPoint, 3> patch)
			{
				...
				// Calcul des facteurs de tessellation interne
